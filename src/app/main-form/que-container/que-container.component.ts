...
export class QueContainerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form
      .get('survey_response')
      .controls[this.index].controls.qId.setValue(this.ar.id);
    this.form
      .get('survey_response')
      .controls[this.index].controls.type.setValue(this.ar.type);
    this.form
      .get('survey_response')
      .controls[this.index].controls.data.setValue(this.ar.question_data);
  }
}
